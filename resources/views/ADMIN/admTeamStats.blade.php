        ...
        <style>
            ...
            @foreach ($data as $d)
                @php
                    $goals = $goals + $d->goals;
                    $shots = $shots + $d->shots;
                    $onTarget = $onTarget + $d->shots_on_goal;
            ...
            var data = [
                {
                Category: "Shots",
                'Total': -@php echo $shots @endphp,
                'Average': @php echo $shots/$number @endphp
              },
                {
                Category: "Shots on goal",
                'Total': -@php echo $onTarget @endphp,
                'Average': @php echo $onTarget/$number @endphp
              },
              {
                Category: "Goals",
                'Total': -@php echo $goals @endphp,
                'Average': @php echo $goals/$number @endphp
              },
                {
                Category: "Assists",
                'Total': -@php echo $assists @endphp,
                'Average': @php echo $assists/$number @endphp
              },
                {
                Category: "Yellow cards",
                'Total': -@php echo $yellow @endphp,
                'Average': @php echo $yellow/$number @endphp
              },
              {
                Category: "Red cards",
                'Total': -@php echo $red @endphp,
                'Average': @php echo $red/$number @endphp
              }
            ];
            ...
            createSeries('Total', am5.p100, "right", -5);
            createSeries('Average', 0, "left", 5);
